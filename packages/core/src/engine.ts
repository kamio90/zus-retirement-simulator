 ...
 *
 * @param input - Simulation parameters (see SimulateInput)
 * @param data - All required macroeconomic, actuarial, and coefficient data loaded from @data
 * @returns SimulationResult with detailed breakdown and assumptions
 */
