/**
 * Legacy App - Original simulator form (v1)
    ...
    <div className="min-h-screen bg-zus-secondary">
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-zus-secondary">
                Profesjonalna kalkulacja przyszłej emerytury
              </p>
            </div>
            <Link
              to="/"
              className="px-4 py-2 bg-zus-accent text-white font-semibold rounded-md hover:bg-white hover:text-zus-primary transition-colors"
            >
              ← Powrót
            </Link>
          </div>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div id="form" className="bg-white rounded-lg shadow-lg p-6">
          <h2 className="text-2xl font-bold text-zus-primary mb-4">Kalkulator Emerytalny (v1)</h2>
